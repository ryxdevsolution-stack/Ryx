            ...
            <div className="grid md:grid-cols-2 gap-6">
              <motion.div className="ig-card-light p-8 md:p-10" {...fadeUpCard(0)}>
                ...
                <p className="text-sm text-neutral-500 leading-relaxed">
                  To build software that solves real business problems — not just demos.
                  Valoryx exists because we needed better billing software. Chendur &amp; Co
                  needed leads through WhatsApp. BigTeam needed a team management platform.
                  We build what businesses actually use.
                </p>
              </motion.div>
              ...
              <motion.div className="ig-card-light p-8 md:p-10" {...fadeUpCard(1)}>
                ...
                <p className="text-sm text-neutral-500 leading-relaxed">
                  ...
                  in India. Every business owner deserves production-grade
